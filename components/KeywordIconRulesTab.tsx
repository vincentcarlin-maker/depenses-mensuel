                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-xl bg-blue-50 hover:bg-blue-100 dark:bg-blue-950/70 dark:hover:bg-blue-900 border border-blue-200 dark:border-blue-800 flex items-center justify-center gap-1.5 text-blue-700 dark:text-blue-300 font-bold text-xs transition-all active:scale-95 cursor-pointer shadow-2xs"
                      title="Modifier la règle"
                      aria-label={`Modifier la règle pour ${rule.keyword}`}
                    >
                    ...
                    <button
                      ...
                      className="px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-xl bg-rose-50 hover:bg-rose-100 dark:bg-rose-950/70 dark:hover:bg-rose-900 border border-rose-200 dark:border-rose-800 flex items-center justify-center gap-1.5 text-rose-700 dark:text-rose-300 font-bold text-xs transition-all active:scale-95 cursor-pointer shadow-2xs"
                      title="Supprimer la règle"
                      aria-label={`Supprimer la règle pour ${rule.keyword}`}
                    >
                      <svg className="w-4 h-4 stroke-[2.5]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
