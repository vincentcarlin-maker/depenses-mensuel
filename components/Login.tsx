            ...
            <div className="w-full max-w-lg">
                ...
                <div className="bg-white dark:bg-slate-800/95 backdrop-blur-md rounded-3xl shadow-xl p-6 sm:p-8 border border-slate-200/80 dark:border-slate-700/70 transition-all">
                    ...
                    {view === 'welcome' && (
                        <div className="space-y-5 animate-fade-in">
                            ...
                            <button
                                ...
                                className="w-full text-left p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-sky-50 to-cyan-50/60 dark:from-sky-950/40 dark:to-slate-800 border-2 border-sky-200 dark:border-sky-800/60 hover:border-sky-400 dark:hover:border-sky-600 shadow-sm hover:shadow-md transition-all group relative overflow-hidden"
                            >
                                <div className="flex items-start gap-3.5">
                                    <div className="w-12 h-12 rounded-2xl bg-sky-500 text-white flex items-center justify-center text-2xl shadow-md group-hover:scale-105 transition-transform shrink-0">
                                        🏠
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-sky-100 dark:bg-sky-900 text-sky-700 dark:text-sky-300 uppercase tracking-wide">
                                                Nouveau
                                            </span>
                                        </div>
                            ...
                            <button
                                ...
                                className="w-full text-left p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-pink-50 to-rose-50/60 dark:from-pink-950/30 dark:to-slate-800 border-2 border-pink-200 dark:border-pink-800/60 hover:border-pink-400 dark:hover:border-pink-600 shadow-sm hover:shadow-md transition-all group relative overflow-hidden"
                            >
                                <div className="flex items-start gap-3.5">
                                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-500 text-white flex items-center justify-center text-2xl shadow-md group-hover:scale-105 transition-transform shrink-0">
                                        🔗
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-pink-100 dark:bg-pink-900 text-pink-700 dark:text-pink-300 uppercase tracking-wide">
                                                Partenaire
                                            </span>
                                        </div>
                                        <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                                            Votre partenaire vous a donné un code d’invitation (ex: <code className="font-mono font-bold bg-pink-100 dark:bg-pink-900/60 px-1 py-0.5 rounded text-pink-700 dark:text-pink-300">VIN-SOP</code>) ? Rejoignez son espace !
                                        </p>
                                    </div>
                            ...
                            <div className="pt-2 border-t border-slate-100 dark:border-slate-700/60">
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-800 dark:text-slate-100 font-bold text-sm transition-all"
                                >
                                    <span>🔑</span>
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-700/80 text-center">
                        <div className="flex flex-wrap items-center justify-center gap-2 text-[11px] font-medium text-slate-500 dark:text-slate-400">
                            <span className="inline-flex items-center gap-1 bg-slate-100 dark:bg-slate-700/60 px-2 py-0.5 rounded-md">
