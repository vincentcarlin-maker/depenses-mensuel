...
export const PRESET_CATEGORY_ICONS: CategoryIconDef[] = [
  ...
  { id: 'cinema', name: 'CinemaIcon', label: 'Cinéma & Spectacles', icon: CinemaIcon },
  { id: 'coffee', name: 'CoffeeIcon', label: 'Café & Pause', icon: CoffeeIcon },
  { id: 'doctor', name: 'DoctorIcon', label: 'Médecin & Soins', icon: DoctorIcon },
  { id: 'baby', name: 'BabyIcon', label: 'Bébé & Enfants', icon: BabyIcon },
  { id: 'bakery', name: 'BakeryIcon', label: 'Boulangerie & Pain', icon: BakeryIcon },
  { id: 'gaming', name: 'GamingIcon', label: 'Jeux vidéo & Loisirs', icon: GamingIcon },
  { id: 'bardrinks', name: 'BarDrinksIcon', label: 'Bar & Soirées', icon: BarDrinksIcon },
  { id: 'beautysalon', name: 'BeautySalonIcon', label: 'Coiffure & Esthétique', icon: BeautySalonIcon },
  { id: 'tvsubscription', name: 'TvSubscriptionIcon', label: 'Télé & Séries', icon: TvSubscriptionIcon },
  { id: 'books', name: 'BooksIcon', label: 'Livres & Culture', icon: BooksIcon },
  { id: 'bankfinance', name: 'BankFinanceIcon', label: 'Banque & Finances', icon: BankFinanceIcon },
  { id: 'taxfinance', name: 'TaxFinanceIcon', label: 'Impôts & Taxes', icon: TaxFinanceIcon },
  { id: 'traintransit', name: 'TrainTransitIcon', label: 'Train & Transports', icon: TrainTransitIcon },
  { id: 'bicycle', name: 'BicycleIcon', label: 'Vélo & Mobilité', icon: BicycleIcon },
  { id: 'hotel', name: 'HotelIcon', label: 'Hôtel & Séjour', icon: HotelIcon },
  { id: 'diytools', name: 'DiyToolsIcon', label: 'Bricolage & Outils', icon: DiyToolsIcon },
  { id: 'gardenplant', name: 'GardenPlantIcon', label: 'Jardin & Plantes', icon: GardenPlantIcon },
  { id: 'laundry', name: 'LaundryIcon', label: 'Lessive & Entretien', icon: LaundryIcon },
  { id: 'electricity', name: 'ElectricityIcon', label: 'Électricité', icon: ElectricityIcon },
  { id: 'waterdrop', name: 'WaterDropIcon', label: 'Eau courante', icon: WaterDropIcon },
  { id: 'gascylinder', name: 'GasCylinderIcon', label: 'Gaz & Bouteille', icon: GasCylinderIcon },
  { id: 'concertfestival', name: 'ConcertFestivalIcon', label: 'Concert & Billets', icon: ConcertFestivalIcon },
  { id: 'fastfood', name: 'FastFoodIcon', label: 'Fast food & Pizza', icon: FastFoodIcon },
  { id: 'dentist', name: 'DentistIcon', label: 'Dentiste & Dents', icon: DentistIcon },
  { id: 'glasses', name: 'GlassesIcon', label: 'Optique & Lunettes', icon: GlassesIcon },
  { id: 'carwash', name: 'CarWashIcon', label: 'Lavage Auto', icon: CarWashIcon },
  { id: 'parkingtoll', name: 'ParkingTollIcon', label: 'Parking & Péage', icon: ParkingTollIcon },
  { id: 'savingspiggy', name: 'SavingsPiggyIcon', label: 'Tirelire & Épargne', icon: SavingsPiggyIcon },
  { id: 'schoolsupplies', name: 'SchoolSuppliesIcon', label: 'École & Fournitures', icon: SchoolSuppliesIcon },
  { id: 'donationcharity', name: 'DonationCharityIcon', label: 'Dons & Entraide', icon: DonationCharityIcon },
];
        ...
        <form onSubmit={handleSubmit} className="space-y-4 flex-1 overflow-y-auto pr-1">
          ...
          <div className="space-y-2 pt-1">
            ...
            <div className="grid grid-cols-6 gap-2 max-h-48 overflow-y-auto p-1.5 rounded-2xl bg-slate-50/50 dark:bg-slate-700/30 border border-slate-200/70 dark:border-slate-700/70">
              ...
              {/* Custom Uploaded Icons from Categories / Admin */}
              {customIcons.map(ci => {
                ...
                return (
                  <div key={ci.id} className="relative group">
                    ...
                    {/* Trash can / Corbeille to delete custom category icon */}
                    <button
                      type="button"
                      onClick={(e) => {
                        e.stopPropagation();
                        deleteCustomIcon(ci.id);
                        if (selectedIconId === ci.id || selectedIconId === ci.name) {
                          setSelectedIconId('misc');
                        }
                      }}
                      className="absolute -top-1.5 -right-1.5 w-6 h-6 rounded-full bg-rose-500 hover:bg-rose-600 active:scale-90 text-white flex items-center justify-center shadow-md transition-all cursor-pointer z-10"
                      title={`Supprimer l'icône « ${ci.name} »`}
                      aria-label={`Supprimer l'icône « ${ci.name} »`}
                    >
                      <svg className="w-3.5 h-3.5 stroke-[2.5]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
